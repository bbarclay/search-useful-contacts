...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Set up a new password for Business Blueprint</title>
    <!-- 
    ...
    *:not(br):not(tr):not(html) {
    ...
    .button--green {
      ...
      border-top: 10px solid #79c142;
      border-right: 18px solid #79c142;
      border-bottom: 10px solid #79c142;
      border-left: 18px solid #79c142;
    }
    ...
    p.center {
     ...
     <body>
      ...
      <span class="preheader">New contact has been added.</span>
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="email-masthead">
                    <a href="http://my.businessblueprint.com" class="email-masthead_name">
                       <img src="http://businessblueprint.com.au/wp-content/uploads/2018/05/logo-v2.png"  width="200" />
                     </a>
                  </td>
                </tr>
                <!-- Email Body -->
                    ...
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="content-cell">
                          ...
                          <p>Thanks,
                            <br>The Business Blueprint Team</p>
                          <!-- Sub copy -->
                          <table class="body-sub">
                            <tr>
                              <td>
                                <p class="sub">If you’re having trouble with the button above, copy and paste the URL below into your web browser.</p>
                                <p class="sub"><?php echo $url; ?></p>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td class="content-cell" align="center">
                          <p class="sub align-center">
                            ...
                            PO BOX 808, Newport NSW 2106, Australia
                          </p>
                        </td>
                      </tr>
                    </table>
